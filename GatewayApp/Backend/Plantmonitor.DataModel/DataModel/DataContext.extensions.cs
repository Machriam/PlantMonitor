...
public partial class DataContext
{
    ...
    private partial void OnModelCreatingPartial(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PhotoTourTrip>().Property(p => p.SegmentationTemplateJson).HasColumnType("jsonb").HasColumnName("segmentation_template");
        modelBuilder.Entity<PhotoTourTrip>().Ignore(p => p.SegmentationTemplate);
