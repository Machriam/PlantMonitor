...
<div class="top-row ps-3 navbar navbar-dark">
	<div class="container-fluid">
		<a class="navbar-brand" href="/">Plantmonitor</a>
...
>
	<nav class="flex-column">
		...
		<div class="nav-item px-3">
			<a class="nav-link" href="deviceConfiguration">
		...
		<div class="nav-item px-3">
			<a class="nav-link" href="replayPictures">
