...
namespace PlantMonitorControl.Tests.Features.ImageTaking
{
    public class FileStreamingReaderTests
    {
        ...
        public async Task ReadNextFile_Skipping_ShouldWork()
        {
            ...
            var result = await sut.ReadNextFileWithSkipping(testDir.FullName, 0, 10, default);
            ...
            {
                result = await sut.ReadNextFileWithSkipping(testDir.FullName, result.NewCounter, 10, default);
